...
- **[swatch](https://github.com/nitrimandylis/swatch)** one palette, individual macos app surfaces, written from a single source
...
- **[siren](https://github.com/nitrimandylis/siren)** every alert that has to poll something, one folder and one cron each
